    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Seat", x => new { x.Id, x.HallId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainRole = table.Column<bool>(type: "bit", nullable: false),
                    ActorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Role", x => new { x.Id, x.MovieId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatReservation", x => new { x.SeatId, x.Reservationid, x.HallId });
                    table.ForeignKey(
                        name: "FK_SeatReservation_Hall_HallId",
                        column: x => x.HallId,
                        principalTable: "Hall",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SeatReservation_Seat_SeatId_HallId",
                        columns: x => new { x.SeatId, x.HallId },
                        principalTable: "Seat",
                        principalColumns: new[] { "Id", "HallId" });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatReservation_HallId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatReservation_SeatId_HallId",
                table: "SeatReservation",
